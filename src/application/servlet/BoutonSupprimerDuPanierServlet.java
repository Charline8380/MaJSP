...
/**
 * Servlet implementation class BoutonSupprimerDuPanierServlet
 */
@WebServlet("/BoutonSupprimerDuPanierServlet")
public class BoutonSupprimerDuPanierServlet extends HttpServlet {
     ...
     */
    public BoutonSupprimerDuPanierServlet() {
        super();
	...
	protected void doGet(final HttpServletRequest request,final HttpServletResponse response) throws ServletException, IOException {
        ...
        panier = panierService.deleteProduitPanier(panier, id);
